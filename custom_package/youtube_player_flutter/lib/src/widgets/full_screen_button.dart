...
class FullScreenButton extends StatefulWidget {
  ...
  const FullScreenButton({super.key,
    this.controller,
    this.color = Colors.white, this.onFullScreen,
  });

  @override
  FullScreenButtonState createState() => FullScreenButtonState();
}
    ...
    return IconButton(
      ...
      onPressed: () {
        if(widget.onFullScreen != null){
          widget.onFullScreen!(!_controller.value.isFullScreen);
        }else{
          debugPrint("onFullScreen call back not available");
        }
