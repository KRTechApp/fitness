...
class RawYoutubePlayer extends StatefulWidget {
  ...
  const RawYoutubePlayer({super.key,
    this.onEnded, this.youTubeKey,
  });

  @override
  RawYoutubePlayerState createState() => RawYoutubePlayerState();
}

class RawYoutubePlayerState extends State<RawYoutubePlayer>
