...
class PayPalPaymentDetailBottamSheet extends StatefulWidget {
  final QueryDocumentSnapshot queryDocumentSnapshot;
  final QueryDocumentSnapshot? subCollectionData;

  const PayPalPaymentDetailBottamSheet({super.key, this.subCollectionData, required this.queryDocumentSnapshot});

  @override
  State<PayPalPaymentDetailBottamSheet> createState() => _PayPalPaymentDetailBottamSheetState();
}

class _PayPalPaymentDetailBottamSheetState extends State<PayPalPaymentDetailBottamSheet> {
  @override
            ...
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    children: [
                      Text(AppLocalizations.of(context)!.email.allInCaps, maxLines: 1, style: GymStyle.boldText),
                      const Spacer(),
                      SizedBox(
                        width: width * 0.45,
                        child: Text((widget.subCollectionData![keyPaymentEmail] ?? "").toString().firstCapitalize(),
                            maxLines: 1, style: GymStyle.popupbox),
                      ),
                    ],
                  ),
