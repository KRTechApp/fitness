...
class CustomCalendarAppDemo extends StatefulWidget {
  ...
  const CustomCalendarAppDemo(
      {super.key, required this.measurementList, this.currentView = CalendarViews.month, this.onDateChange});

  @override
  _CustomCalendarAppDemoState createState() => _CustomCalendarAppDemoState();
}

class _CustomCalendarAppDemoState extends State<CustomCalendarAppDemo> {
                ...
                SizedBox(
                  ...
                  child: Center(
                    child: Text(
                      ...
                      style: GymStyle.containerHeader1,
                    ),
                  ),
                ),
                const Spacer(),
  ...
  Widget _calendarBodyMonth() {
    ...
    return GridView.builder(
      ...
      gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
          childAspectRatio: 1, crossAxisCount: 7, crossAxisSpacing: 5, mainAxisSpacing: 10),
