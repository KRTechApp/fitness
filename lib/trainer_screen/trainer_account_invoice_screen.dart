...
import 'trainer_invoice_item_view.dart';

class TrainerAccountInvoiceScreen extends StatefulWidget {
  final ShowProgressDialog showProgressDialog;
  const TrainerAccountInvoiceScreen({Key? key, required this.showProgressDialog}) : super(key: key);

  @override
  State<TrainerAccountInvoiceScreen> createState() => _TrainerAccountInvoiceScreenState();
}

class _TrainerAccountInvoiceScreenState extends State<TrainerAccountInvoiceScreen> {

  String? selectedValueByFilter;
  String? selectedValueBySortShow;
              ...
              child: DropdownButtonHideUnderline(
                child: DropdownButton2(
                  ...
                  items: sortBy
                      ...
                      .toList(),
                  value: selectedValueBySortShow,
                  onChanged: (value) {
                    setState(
                      () {
                        selectedValueBySortShow = value as String;
                        if (selectedValueBySortShow == AppLocalizations.of(context)!.newest_first) {
                          sortByCreated = true;
                        } else {
                          sortByCreated = false;
                        }
