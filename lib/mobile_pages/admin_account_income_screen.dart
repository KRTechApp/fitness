...
import '../custom_widgets/admin_account_incom_item_view.dart';
import '../utils/gym_style.dart';
import '../utils/tables_keys_values.dart';
import '../utils/utils_methods.dart';

class AdminAccountIncomeScreen extends StatefulWidget {
  final ShowProgressDialog showProgressDialog;
  const AdminAccountIncomeScreen({
    Key? key, required this.showProgressDialog,
  }) : super(key: key);

  @override
  State<AdminAccountIncomeScreen> createState() => _AdminAccountIncomeScreenState();
}

class _AdminAccountIncomeScreenState extends State<AdminAccountIncomeScreen> {
            ...
            builder: (context, paymentData, child) => paymentData.paymentHistoryItemList.isNotEmpty
                ? ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return AdminAccountIncomeItemView(
                        userRole: userRole,
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(
                            AppLocalizations.of(context)!.you_do_not_have_any_income_history,
                            maxLines: 2,
