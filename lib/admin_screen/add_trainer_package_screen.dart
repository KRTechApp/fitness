...
import '../trainer_screen/tag_view_item_view.dart';
import '../utils/firebase_interface.dart';
import '../utils/gym_style.dart';
import '../utils/shared_preferences_manager.dart';
import '../utils/static_data.dart';
import '../utils/utils_methods.dart';
import 'select_trainer_list.dart';
...
class _AddTrainerPackageScreenState extends State<AddTrainerPackageScreen> {
  ...
  TextEditingController memberShipName = TextEditingController();
  TextEditingController amount = TextEditingController();
  TextEditingController period = TextEditingController();
  TextEditingController classLimit = TextEditingController();
  TextEditingController memberLimit = TextEditingController();
    ...
    WidgetsBinding.instance.addPostFrameCallback(
      (_) async {
        ...
        if ((widget.viewType == "edit" || widget.viewType == "view") && widget.documentSnapshot != null) {
          debugPrint("AddTrainerPackageScreen : ${widget.documentSnapshot!.id}");
          ...
          classLimit.text = widget.documentSnapshot!.get(keyClassLimit).toString();
          memberLimit.text = widget.documentSnapshot!.get(keyMemberLimit).toString();
          enableRecurringPackage = widget.documentSnapshot!.get(keyRecurringPackage);

          List<String> tempTrainerList = List.castFrom(widget.documentSnapshot!.get(keyAssignedMembers) as List);
          memberSelectionModel.selectedMember!.addAll(tempTrainerList);
          memberSelectionModel.alreadySelectedMember!.addAll(tempTrainerList);
          ...
          title: Text(
            widget.viewType == "view"
                ? userRole == userRoleAdmin
                    ? AppLocalizations.of(context)!.view_packages
                    : AppLocalizations.of(context)!.view_membership
                : (widget.viewType == "edit"
                    ? userRole == userRoleAdmin
                        ? AppLocalizations.of(context)!.edit_packages
                      ...
                      children: [
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            labelText: userRole == userRoleAdmin
                                ? '${AppLocalizations.of(context)!.package_name}*'
                                : '${AppLocalizations.of(context)!.membership_name}*',
                        ...
                        TextFormField(
                          ...
                          cursorColor: ColorCode.mainColor,
                          readOnly: widget.viewType == "view" ? true : false,
                          controller: classLimit,
                          validator: (value) {
                            if (value == null || value.trim().isEmpty) {
                              return AppLocalizations.of(context)!.please_enter_class_limit;
                            }
                            return null;
                          },
                          decoration: InputDecoration(
                            ...
                            labelText: '${AppLocalizations.of(context)!.class_limit}*',
                            labelStyle: GymStyle.inputText,
                          ),
                        ),
                        const SizedBox(
                        ...
                        TextFormField(
                          ...
                          validator: (value) {
                            if (value == null || value.trim().isEmpty) {
                              return AppLocalizations.of(context)!.please_enter_member_limit;
                            }
                            return null;
                          },
                          decoration: InputDecoration(
                            ...
                            labelText: '${AppLocalizations.of(context)!.member_limit}*',
                            labelStyle: GymStyle.inputText,
                          ),
                        ),
                        const SizedBox(
                        ...
                        Row(
                          children: [
                            ...
                            Text(
                              AppLocalizations.of(context)!.recurring_package,
                              style: TextStyle(
                                  fontSize: 16,
                        ...
                        DottedBorder(
                          ...
                          child: InkWell(
                            onTap: () {
                              ...
                              widget.viewType == "view" ? Fluttertoast.showToast(
                        ...
                        Padding(
                          ...
                          child: Text(AppLocalizations.of(context)!.trainer, style: GymStyle.inputText),
                        ),
                        Tags(
                          alignment: WrapAlignment.start,
                          ...
                          itemBuilder: (index) {
                            return FutureBuilder(
                              ...
                              future: trainerProvider.getSingleTrainer(
                                userId: memberSelectionModel.selectedMember![index],
                              ),
                      ...
                      if (formKey.currentState!.validate()) {
                        if (widget.viewType == "edit") {
                          ...
                          membershipProvider
                              .updateMembership(
                            userRole: userRole,
                                  assignTrainer: memberSelectionModel.selectedMember!,
                                  currentUserId: userId,
                                  membershipId: widget.documentSnapshot!.id,
                                  amount: amount.text.trim().toString(),
                                  period: period.text.trim().toString(),
                                  classLimit: classLimit.text.trim().toString(),
                                  memberLimit: memberLimit.text.trim().toString(),
                                      ...
                                      if (defaultResponseData.status != null && defaultResponseData.status!)
                                        {
                                          Fluttertoast.showToast(
                                              ...
                                              textColor: Colors.white,
                                              fontSize: 16.0),
                                          trainerProvider.assignMembershipToTrainer(
                                              context: context,
                                              membershipDoc: widget.documentSnapshot!,
                                              selectedTrainerList: memberSelectionModel.selectedMember!,
                                              alreadySelectedTrainerList: memberSelectionModel.alreadySelectedMember!,
                                              unSelectedTrainerList: memberSelectionModel.unselectedMember!),
                                          Navigator.pop(context)
                                        }
                                      else
                                        {
                          ...
                          /*   if(selectedTraineList != null && selectedTraineList != ""){
                            member
                          }*/
                        }
                      }
                      ...
                      widget.viewType == "view"
                          ...
                          : (widget.viewType == "edit"
                              ? userRole == userRoleAdmin
                                  ...
                                  : AppLocalizations.of(context)!.save.allInCaps
                              : userRole == userRoleAdmin
                                  ? AppLocalizations.of(context)!.add_packages.allInCaps
